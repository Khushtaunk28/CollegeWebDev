    ...
    <div className='flex flex-col justify-start gap-5'>
      <h2 className='text-4xl font-palanquin font-bold'>Our
       <span className='text-coral-red'> Popular </span>
         Products</h2>
      <p className='lg:max-w-lg mt-2 font-montserrat text-slate-gray'>Experience Top Notch Quality and Styles and Disvoer a world og 
        comfort and style with our wide range of products.
      </p>
    </div>
